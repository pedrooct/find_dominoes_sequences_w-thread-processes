...
int recursive_backtrack(HAND *hands, SEQUENCE *seq, ALLSEQUENCES *allseq, short inserted,int save);
...
void save_sequence(ALLSEQUENCES *pAll_sequences, SEQUENCE *pSequence,int save);
